...
#3.a​Crear una clase ProductsList que lo parsee y almacene la información en una colección de productos.
#3.b​Teniendo en cuenta la lista de productos anterior, crear una clase Purchase que procese órdenes de compra. Dicha clase deberá: #Implementar un método #add(producto) que agregue un producto a la orden. Si el producto no está en la lista, no lo agregará a la compra.#Implementar un método #total que calcule el total de los elementos agregados.
#3.c Incorporar lógica de procesamiento de descuentos al sistema anterior de manera que si el total supera los $200, se aplique un #descuento del 10%
#3.d ​Extender la funcionalidad para que le procesamiento de descuentos permita aplicar los siguientes descuentos:
...
#3.e ​Extender la solución anterior de manera que se puedan agregar y modificar reglas descuentos y promociones
